...
namespace ACOT.Exchange1CModule          
{
    public partial class LayoutView : UserControl, ISmartPartInfoProvider
    {
        ...
        {
            _presenter.CloseLayoutView();
        }


        public void Layout_OnClosing(object sender, FormClosingEventArgs e)
        {
            //e.Cancel = true;
            _presenter.CloseLayoutView();
        }

        private void _openRulesFileBtn_Click(object sender, EventArgs e)
        {
